...
#git: https://github.com/luyishisi/Anti-Anti-Spider.git
...
class IndustryAndCommerceGeetestCrack():
    def __init__(self,
                 ...
                 username_input_id="session_email_or_mobile_number",
                 password_input_id="session_password",
                 login_click_class="sign-in-button",
        ...
        username: 用户名
        password: 密码
        username_input_id: 用户名输入框id
        password_input_id: 密码输入框id
        login_click_class: 登录按钮class类名
        ...
        # google
        opts = Options()
        #opts.binary_location = '/data/App/Google Chrome.app/Contents/MacOS/Google Chrome'  #mac
        opts.binary_location = 'C:\Program Files (x86)\Google\Chrome\Application\chrome.exe'  #windows
    ...
    def crop_captcha_image(self, gt_element_class_name="gt_box", imgname=None):
    ...
    def calculate_slider_offset(self,
        ...
        :returns: Number
        """
        img1 = self.crop_captcha_image(gt_element_class_name=gt_element_class_name, imgname='beforedrag.png')
        self.drag_and_drop_test(x_offset=5)
        img2 = self.crop_captcha_image(gt_element_class_name=gt_element_class_name, imgname='afterdrag.png')
        w1, h1 = img1.size
        w2, h2 = img2.size
        if w1 != w2 or h1 != h2:
            return False
